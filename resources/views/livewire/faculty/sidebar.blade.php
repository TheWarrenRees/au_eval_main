                ...
                <ul class="mt-2 ">
                    <li class="ps-3 border-l-2 border-sky-950 hover:border-sky-400 transition ease-in-out duration-400">
                        <a wire:navigate href="{{route('faculty.dashboard')}}" class="p-2 w-100 flex items-center gap-3 text-slate-400 hover:text-sky-400">
                            ...
                            <span class="text-xs uppercase font-bold" style="font-size: 10px;">Student Reviews</span>
                        </a>
                    </li>
                    <li class="ps-3 border-l-2 border-sky-950 hover:border-sky-400 transition ease-in-out duration-400">
                        <a wire:navigate href="{{route('faculty.peer-dashboard')}}" class="p-2 w-100 flex items-center gap-3 text-slate-400 hover:text-sky-400">
                            <div class="p-2 rounded-lg bg-slate-800">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                                </svg>
                            </div>
                            <span class="text-xs uppercase font-bold" style="font-size: 10px;">Evaluate Faculty</span>
                        </a>
                    </li>
                </ul>
            </li>
