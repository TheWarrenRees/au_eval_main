<div>
    <h1 class="text-3xl font-semibold">Faculty Questionnaire Items</h1>
    <p class="text-sm font-medium mt-1 text-slate-900">List of all items in faculty questionnaire created.</p>
