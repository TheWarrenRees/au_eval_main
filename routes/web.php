...
use App\Http\Controllers\Admin\PeerReviewsController;
use App\Http\Controllers\Admin\PeerEvaluationResultController;
use App\Http\Controllers\Admin\PeerQuestionnaireController;
use App\Http\Controllers\Admin\PeerQuestionnaireItemController;
...
use App\Http\Controllers\Faculty\PeerDashboardController as FacultyPeerDashboardController;
// use App\Http\Controllers\Faculty\PeerController as FacultyPeerController;
use App\Http\Controllers\Faculty\DepartmentController as FacultyDepartmentController;
...
use App\Http\Controllers\Faculty\PeerFacultyController as FacultyPeerFacultyController;
use App\Http\Controllers\Faculty\PeerEvaluateController as PeerEvaluateController;
...
Route::prefix('admin')->middleware('admins')->group(function() {
    ...
    Route::middleware('role:superadmin')->prefix('programs')->group(function() {
        ...
        Route::get('/peer-reviews', [PeerReviewsController::class, 'index'])->name('admin.programs.peer-reviews');
        Route::get('/peer-reviews/peer-evaluation', [PeerEvaluationResultController::class, 'index'])->name('admin.programs.peer-evaluation');
        ...
        Route::get('/peer-questionnaire', [PeerQuestionnaireController::class, 'index'])->name('admin.programs.peer-questionnaire');
        Route::get('/peer-questionnaire/{slug}', [PeerQuestionnaireItemController::class, 'index'])->name('admin.programs.peer-questionnaire.item');
...
Route::prefix('faculty')->group(function() {
    ...
    Route::middleware('faculty')->group(function() {
        ...
        Route::get('peer-dashboard', [FacultyPeerDashboardController::class, 'index'])->name('faculty.peer-dashboard');
        Route::get('department', [FacultyDepartmentController::class, 'index'])->name('faculty.department');
        ...
        Route::get('peer-faculty', [FacultyPeerFacultyController::class, 'index'])->name('faculty.peer-faculty');
        Route::get('faculty/evaluate/start', [PeerEvaluateController::class, 'index'])->name('faculty.evaluate');
